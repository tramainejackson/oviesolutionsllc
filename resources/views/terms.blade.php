<x-app-layout>
    ...
    <div class="accordion accordion-flush" id="termsAccordion">
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse1" class="accordion-collapse collapse show term_section" aria-labelledby="heading1">

                <div class="accordion-body" id="section1">
                    <p class="">By agreeing to these Terms of Service, you represent that you are at least the age of
                        majority in your state or province of residence, or that you are the age of majority in your
                        state
                        or province of residence and you have given us your consent to allow any of your minor
                        dependents to
                        use this site.
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse2" class="accordion-collapse collapse term_section" aria-labelledby="heading2">

                <div class="accordion-body" id="section2">

                    <p class="">We reserve the right to refuse service to anyone for any reason at any time.
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse3" class="accordion-collapse collapse term_section" aria-labelledby="heading3">

                <div class="accordion-body" id="section3">

                    <p class="">We are not responsible if information made available on this site is not accurate,
                        complete
                        or
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse4" class="accordion-collapse collapse term_section" aria-labelledby="heading4">

                <div class="accordion-body" id="section4">

                    <p class="">Prices for our services or product offerings s are subject to change without notice.
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse5" class="accordion-collapse collapse term_section" aria-labelledby="heading5">

                <div class="accordion-body" id="section5">

                    <p class="">Certain products or services may be available exclusively online through the website.
                        These
                        ...
                        descriptions of
                        products or product pricing are subject to change at anytime without notice, at the sole
                        discretion
                        of
                        ...
                        purchased
                        or obtained by you will meet your expectations, or that any errors in the Service will be
                        corrected.
                    </p>
                </div>
            </div>
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse6" class="accordion-collapse collapse term_section" aria-labelledby="heading6">

                <div class="accordion-body" id="section6">

                    <p class="">We reserve the right to refuse any order you place with us. We may, in our sole
                        discretion,
                        ...
                        provided
                        at
                        the time the order was made. We reserve the right to limit or prohibit orders that, in our sole
                        judgment, appear to be placed by dealers, resellers or distributors.

                        You agree to provide current, complete and accurate purchase and account information for all
                        purchases
                        made at our store. You agree to promptly update your account and other information, including
                        your
                        email
                        address and credit card numbers and expiration dates, so that we can complete your transactions
                        and
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse7" class="accordion-collapse collapse term_section" aria-labelledby="heading7">

                <div class="accordion-body" id="section7">

                    <p class="">We may provide you with access to third-party tools over which we neither monitor nor
                        have
                        any
                        control nor input.
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse8" class="accordion-collapse collapse term_section" aria-labelledby="heading8">

                <div class="accordion-body" id="section8">

                    <p class="">Certain content, products and services available via our Service may include materials
                        from
                        third-parties.
                        ...
                        and
                        will not have any liability or responsibility for any third-party materials or websites, or for
                        any
                        ...
                        engage
                        in any transaction. Complaints, claims, concerns, or questions regarding third-party products
                        should
                        be
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse9" class="accordion-collapse collapse term_section" aria-labelledby="heading9">

                <div class="accordion-body" id="section9">

                    <p class="">If, at our request, you send certain specific submissions (for example contest entries)
                        or
                        ...
                        that we
                        may, at any time, without restriction, edit, copy, publish, distribute, translate and otherwise
                        use
                        in
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse10" class="accordion-collapse collapse term_section" aria-labelledby="heading10">

                <div class="accordion-body" id="section10">

                    <p class="">Your submission of personal information through the store is governed by our Privacy
                        Policy.
                        To
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse11" class="accordion-collapse collapse term_section" aria-labelledby="heading11">

                <div class="accordion-body" id="section11">

                    <p class="">Occasionally there may be information on our site or in the Service that contains
                        typographical
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse12" class="accordion-collapse collapse term_section" aria-labelledby="heading12">

                <div class="accordion-body" id="section12">

                    <p class="">In addition to other prohibitions as set forth in the Terms of Service, you are
                        prohibited
                        from
                        ...
                        information;
                        (g)
                        to upload or transmit viruses or any other type of malicious code that will or may be used in
                        any
                        way
                        that will affect the functionality or operation of the Service or of any related website, other
                        websites, or the Internet; (h) to collect or track the personal information of others; (i) to
                        spam,
                        phish, pharm, pretext, spider, crawl, or scrape; (j) for any obscene or immoral purpose; or (k)
                        to
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse13" class="accordion-collapse collapse term_section" aria-labelledby="heading13">

                <div class="accordion-body" id="section13">

                    <p class="">We do not guarantee, represent or warrant that your use of our service will be
                        uninterrupted,
                        ...
                        non-infringement.
                        In no case shall Ovie Solutions LLC, our directors, officers, employees, affiliates, agents,
                        ...
                        including,
                        without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or
                        any
                        ...
                        any
                        other
                        claim related in any way to your use of the service or any product, including, but not limited
                        to,
                        any
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse14" class="accordion-collapse collapse term_section" aria-labelledby="heading14">

                <div class="accordion-body" id="section14">

                    <p class="">You agree to indemnify, defend and hold harmless Ovie Solutions LLC and our parent,
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse15" class="accordion-collapse collapse term_section" aria-labelledby="heading15">

                <div class="accordion-body" id="section15">

                    <p class="">In the event that any provision of these Terms of Service is determined to be unlawful,
                        void
                        or
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse16" class="accordion-collapse collapse term_section" aria-labelledby="heading16">

                <div class="accordion-body" id="section16">
                    <p class="">The obligations and liabilities of the parties incurred prior to the termination date
                        shall
                        ...
                        terminate
                        these Terms of Service at any time by notifying us that you no longer wish to use our Services,
                        or
                        when
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse17" class="accordion-collapse collapse term_section" aria-labelledby="heading17">

                <div class="accordion-body" id="section17">

                    <p class="">The failure of us to exercise or enforce any right or provision of these Terms of
                        Service
                        shall
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse18" class="accordion-collapse collapse term_section" aria-labelledby="heading18">

                <div class="accordion-body" id="section18">

                    <p class="">These Terms of Service and any separate agreements whereby we provide you Services shall
                        be
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse19" class="accordion-collapse collapse term_section" aria-labelledby="heading19">

                <div class="accordion-body" id="section19">

                    <p class="">You can review the most current version of the Terms of Service at any time at this
                        page.
        ...
        <div class="accordion-item">
            ...
            <!-- Body -->
            <div id="collapse20" class="accordion-collapse collapse term_section" aria-labelledby="heading20">

                <div class="accordion-body" id="section20">

                    <p class="">Questions about the Terms of Service should be sent to us at OVIESOLUTIONSLLC@GMAIL.COM.
                        Free delivery on all orders inside the US

                        Free tracking updates on all orders

                        Satisfied or refunded

                        Customers have 7 days after delivery to return items for
                        full refund. After 7 days customers can exchange items for equal or more
                        value. Please email us Ovie Solutions LLC@gmail.com for any questions.


                        Top-notch support

                        Call 202-643-2328 (240) 244 -6086 or email Ovie Solutions LLC@gmail.com during business hours
